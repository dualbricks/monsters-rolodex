...
const App = () => {
  ...
  useEffect(()=>{
    fetch('https://jsonplaceholder.typicode.com/users')
      .then((res)=>res.json()).then((users)=> setMonsters(users), ()=>{
         //
       })
  },[])
  useEffect(()=>{
    const newMonsters = monsters.filter((monster)=>monster.name.toLocaleLowerCase().includes(searchField))
...
//     return (
//       <div className="App">
//       <h1 className='app-title'>Dualbricks</h1>
